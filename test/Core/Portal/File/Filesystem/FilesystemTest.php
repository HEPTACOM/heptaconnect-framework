...
/**
 * @covers \Heptacom\HeptaConnect\Core\Portal\Filesystem\Filesystem
 */
class FilesystemTest extends TestCase
{
    ...
    {
        static::expectExceptionCode(1666942815);
    ...
    {
        return new Filesystem(Psr17FactoryDiscovery::findUriFactory(), 'heptaconnect-portal-node+123');
    }
}
