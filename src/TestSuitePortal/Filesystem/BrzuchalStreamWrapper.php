...
namespace Heptacom\HeptaConnect\TestSuite\Portal\Filesystem;

use Heptacom\HeptaConnect\Core\File\Filesystem\Contract\StreamWrapperInterface;

final class BrzuchalStreamWrapper implements StreamWrapperInterface
{
    private \FilesystemStreamWrapper $decorated;
    ...
    public function setDecorated(\FilesystemStreamWrapper $decorated): void
    {
