...
- Replace `\Heptacom\HeptaConnect\Storage\Base\Contract\EntityMapperContract::mapEntities` with storage action `\Heptacom\HeptaConnect\Storage\Base\Contract\Action\Mapping\MappingMapActionInterface::map`, `\Heptacom\HeptaConnect\Storage\Base\Action\Mapping\Mapping`, `\Heptacom\HeptaConnect\Storage\Base\Action\Mapping\Map\MappingMapPayload` and `\Heptacom\HeptaConnect\Storage\Base\Action\Mapping\Map\MappingMapResult` that allows for optimizations for different use-cases
