...
{
    public function __construct(private ?string $externalId, private PortalNodeKeyInterface $portalNodeKey, private MappingNodeKeyInterface $mappingNodeKey, private EntityType $entityType)
    {
    }
