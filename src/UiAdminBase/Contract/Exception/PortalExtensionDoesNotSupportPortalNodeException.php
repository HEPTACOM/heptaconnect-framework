...
final class PortalExtensionDoesNotSupportPortalNodeException extends \InvalidArgumentException implements InvalidArgumentThrowableInterface
{
    ...
    public function __construct(
        ...
        parent::__construct('The given portal extension does not support the portal node key', $code, $previous);
