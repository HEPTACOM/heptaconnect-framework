...
final class PortalExtensionIsAlreadyActiveOnPortalNodeException extends \InvalidArgumentException implements InvalidArgumentThrowableInterface
{
    ...
    public function __construct(
        ...
        parent::__construct('The given portal extension is already active on the portal node key', $code, $previous);
